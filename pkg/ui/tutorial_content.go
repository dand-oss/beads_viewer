	...
	return []StructuredTutorialPage{
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				Spacer{Lines: 1},
				Tip{Text: "Start your day with 'bd ready' to see actionable work"},
			},
		},
		{
			ID:      "concepts-labels",
		...
		},
		{
			...
			Elements: []TutorialElement{
				...
				KeyTable{Bindings: []KeyBinding{
					...
					{Key: "~", Desc: "Semantic search (AI-powered)"},
		...
		// =============================================================
		{
			...
			Section: "Advanced",
			Elements: []TutorialElement{
				Section{Title: "Find issues by meaning, not words"},
				Paragraph{Text: "Press ~ to activate semantic search."},
				Spacer{Lines: 1},
				Section{Title: "Fuzzy vs Semantic"},
				KeyTable{Bindings: []KeyBinding{
					{Key: "/ (Fuzzy)", Desc: "Instant, finds exact text"},
					{Key: "~ (Semantic)", Desc: "~1-2s, finds related concepts"},
				}},
				Spacer{Lines: 1},
				Section{Title: "Example"},
				Paragraph{Text: "Searching 'permissions':"},
				Bullet{Items: []string{
					"/ finds issues containing 'permissions'",
					"~ finds access control, roles, authorization, ACLs...",
				}},
				Spacer{Lines: 1},
				Section{Title: "Setup"},
				Code{Text: "export OPENAI_API_KEY=sk-...\n# Or: export EMBEDDING_MODEL=local"},
				Spacer{Lines: 1},
				Tip{Text: "Use natural language: 'issues about slow queries'"},
			},
		},
		{
		...
		// =============================================================
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "bd create --title=\"Implement logic\" --type=task\nbd dep add bv-tests bv-endpoint"},
				Spacer{Lines: 1},
				Section{Title: "Step 4: Complete & Sync"},
				Code{Text: "bd close ID\nbd sync  # Commit changes to git"},
				Spacer{Lines: 1},
				Tip{Text: "Check bd ready after each close - new work may have unblocked"},
			},
		},
		{
			...
			Elements: []TutorialElement{
				...
				Code{Text: "bd create --title=\"Login fails with special chars\" \\\n  --type=bug --priority=2"},
				Spacer{Lines: 1},
				...
				Code{Text: "bd dep add bv-feature1 bv-bug1  # Feature blocked by bug"},
				Spacer{Lines: 1},
